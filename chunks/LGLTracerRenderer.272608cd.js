...
#endif
Ray cam;LGL_AW(cam,origin,direction);vec4 liAndAlpha=LGL_Ao(cam);if(!(liAndAlpha.x<INF&&liAndAlpha.x>-EPS)){liAndAlpha=vec4(0,0,0,1);}out_light=liAndAlpha;}`};function Aa(e,a){const t=[],i=e**a;for(let n=0;n<i;n++)t[n]=n;let o=t.length;const r=[];function l(){o=0}function s(){o>=t.length&&(Ot(t),l());let n=t[o++];for(let f=0;f<a;f++)r[f]=n%e+Math.random(),n=Math.floor(n/e);return r}return{next:s,restart:l,strataCount:e}}function qe(e,a){const t=[];for(const l of a)t.push(Aa(e,l));const i=[];function o(){let l=0;for(const s of t){const n=s.next();for(const f of n)i[l++]=f}return i}function r(){for(const l of t)l.restart()}return{next:o,restart:r,strataCount:e}}let se=[],le=0,me=[];function Ke(e,a){const t=[],i=[];let o=1;const r={x:1,y:2,z:3},l=(s,n=1)=>{if(o=Math.max(n,o),s.primitives)for(let f=0;f<s.primitives.length;f++){const u=s.primitives[f];if(u.indices!==void 0){const p=me[u.meshID];t.push(u.indices[0]+p,u.indices[1]+p,u.indices[2]+p,s.primitives.length,u.faceNormal.x,u.faceNormal.y,u.faceNormal.z,u.meshID)}else t.push(se[u.meshID],u.materialID,u.meshID,0,u.visible,.1,.1,0);i.push(!1)}else{const f=s.bounds;t.push(f.min.x,f.min.y,f.min.z,r[s.splitAxis],f.max.x,f.max.y,f.max.z,null);const u=t.length-1;i.push(!0),l(s.child0,n+1),t[u]=t.length/4+a,l(s.child1,n+1)}};return l(e),{maxDepth:o,count:t.length/4,flatData:t,isBounds:i}}function ha(){se=[],le=0,me=[]}function je(e,a){return Ke(e,le)}function Sa(e,a,t){const i=[];se=[],me=[];let o=0,r=0,l=0,s=1;for(let n=0;n<e.length;n++){const f=e[n],u=a[n].geometry;me.push(r);const p=Ke(f,o);s=Math.max(p.maxDepth,s),se.push(o),o+=p.count,i.push(p),r+=u.getAttribute("position").count,l+=p.flatData.length}return{totalBLASDataNum:l,totalBLASCount:o,flatBVHInfos:i,maxDepth:s}}function Ta(e,a){const t=e.totalBLASDataNum,i=e.flatBVHInfos,o=a,r=o.flatData.length,l=t+r,s=new ArrayBuffer(4*l),n=new Float32Array(s);for(let m=0;m<i.length;m++){const c=i[m],L=se[m]*4,{flatData:x,isBounds:h}=c;for(let I=0;I<h.length;I++){let v=8*I,S=v+L;h[I]?(n[S]=x[v],n[S+1]=x[v+1],n[S+2]=x[v+2],n[S+3]=x[v+3]):(n[S]=x[v],n[S+1]=x[v+1],n[S+2]=x[v+2],n[S+3]=-x[v+3]),n[S+4]=x[v+4],n[S+5]=x[v+5],n[S+6]=x[v+6],n[S+7]=x[v+7]}}const{flatData:f,isBounds:u}=o,p=le*4;for(let m=0;m<u.length;m++){let c=8*m,L=c+p;u[m],n[L]=f[c],n[L+1]=f[c+1],n[L+2]=f[c+2],n[L+3]=f[c+3],n[L+4]=f[c+4],n[L+5]=f[c+5],n[L+6]=f[c+6],n[L+7]=f[c+7]}return{bvhBufferDataNum:l,buffer:n}}function Ma(e,a,t,i){const o=Sa(e,t);le=o.totalBLASCount;const r=je(a),{bvhBufferDataNum:l,buffer:s}=Ta(o,r);return{maxDepth:o.maxDepth+r.maxDepth,count:l/4,buffer:s,tlasRootIndex:le}}let ee,Le;function Fa(e){const a=e.getAttribute("position");if(!a){console.warn("No position attribute");return}const t=new Uint32Array(a.count);for(let i=0;i<t.length;i++)t[i]=i;return e.setIndex(new he(t,1,!1)),e}function Ia(e){let a=0,t=0;for(let o=0;o<e.length;o++){const r=e[o];r.geometry.isBufferGeometry||(r.geometry=new Dt().fromGeometry(r.geometry));const l=r.geometry;l.getIndex()||Fa(l),l.getAttribute("normal")?l.normalizeNormals():l.computeVertexNormals(),a+=l.getAttribute("position").count,t+=l.getIndex().count}const i=Yt(e);return{vertexTotalCount:a,indexCount:t,blasBVHs:i}}function Ze(e,a){return Ht(e,a)}function Je(e){const a=new Float32Array(e.length*16);for(let t=0;t<e.length;t++){const i=e[t];i.updateMatrixWorld(!0);const o=i.matrixWorld.elements,r=16;for(let l=0;l<r;l++)a[t*r+l]=o[l]}return a}function ga(){ee=null,Le=null,ha()}function Ga(e,a){const t=Ze(e,a),i=je(t),o=Je(e),{flatData:r,isBounds:l}=i,{buffer:s}=ee,n=Le*4;for(let f=0;f<l.length;f++){let u=8*f,p=u+n;l[f],s[p]=r[u],s[p+1]=r[u+1],s[p+2]=r[u+2],s[p+3]=r[u+3],s[p+4]=r[u+4],s[p+5]=r[u+5],s[p+6]=r[u+6],s[p+7]=r[u+7]}return{bvhBufferInfo:ee,transformBufferData:o}}function Pa(e,a){var u;let t=e;const{vertexTotalCount:i,blasBVHs:o}=Ia(e),r=Ze(t,a);ee=Ma(o,r,e),Le=ee.tlasRootIndex;const l=new Float32Array(i*4),s=new Float32Array(i*4);let n=0;for(let p=0;p<e.length;p++){const c=e[p].geometry,L=c.getAttribute("position").array,x=c.getAttribute("normal").array,h=(u=c.getAttribute("uv"))==null?void 0:u.array,I=c.getAttribute("position").count;for(let v=0;v<I;v++)l[n+v*4+0]=L[v*3+0],l[n+v*4+1]=L[v*3+1],l[n+v*4+2]=L[v*3+2],l[n+v*4+3]=h?h[v*2+0]:0,s[n+v*4+0]=x[v*3+0],s[n+v*4+1]=x[v*3+1],s[n+v*4+2]=x[v*3+2],s[n+v*4+3]=h?h[v*2+1]:0;n+=I*4}const f=Je(e);return{vertexTotalCount:i,bvhBufferInfo:ee,positionBufferData:l,normalBufferData:s,transformBufferData:f,tlasRootIndex:Le}}function Na(e,a){return new Promise(t=>{const i=Pa(e,a);t(i)})}async function ya({decomposedScene:e,fullscreenQuad:a,gl:t,materialBuffer:i,uvTransformBuffer:o,optionalExtensions:r,useWorker:l,loadingCallback:s}){s&&s.onProgress&&typeof s.onProgress=="function"&&s.onProgress("Building BVH...");const{OES_texture_float_linear:n}=r,{camera:f,meshLightsNum:u,isTextureEnv:p,meshes:m,materialIndexMap:c}=e,{uvTransformBufferTex:L,uvTransformBufferDataCount:x,wrappingRootIndex:h}=o,{vertexTotalCount:I,bvhBufferInfo:v,positionBufferData:S,normalBufferData:g,transformBufferData:_,tlasRootIndex:M}=await Na(m,c),G=v,F=$(t,{defines:Ee({OES_texture_float_linear:n,BVH_COLUMNS:ie(G.count).columnsLog,VERTEX_COLUMNS:ie(I).columnsLog,TRANSFORM_COLUMNS:ie(_.length/4).columnsLog,UVTRANSFORM_COLUMNS:ie(x).columnsLog,SUPPORTED_MAPS:Te.length,MAX_DEPTH:G.maxDepth,USE_LENS_CAMERA:f.isLensCamera,NUM_LIGHTS:u,CONST_COLOR_ENV:!p},i.defines),fragment:_a,vertex:a.vertexShader});return F.setTexture("diffuseMap",i.textures.diffuseMap),F.setTexture("normalMap",i.textures.normalMap),F.setTexture("pbrMap",i.textures.pbrMap),F.setTexture("pbrSGMap",i.textures.pbrSGMap),i.textures.emissiveMap&&F.setTexture("emissiveMap",i.textures.emissiveMap),F.setTexture("positionBuffer",K(t,S,4)),F.setTexture("normalBuffer",K(t,g,4)),F.setTexture("bvhBuffer",K(t,G.buffer,4)),F.setUniform("tlasIndex",M),F.setTexture("transformBuffer",K(t,_,4)),F.setUniform("wrappingIndex",h),F.setTexture("uvTransformBuffer",L),F}async function Ra(e,{bounces:a,decomposedScene:t,fullscreenQuad:i,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,envMapIntensity:s,enviromentVisible:n,useWorker:f,loadingCallback:u}){let p;const m=await ya({bounces:a,decomposedScene:t,fullscreenQuad:i,gl:e,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,useWorker:f,loadingCallback:u}),c=[];h(a),I(t),v(t);function L(A,P){m.setTexture("diffuseMap",A.textures.diffuseMap),m.setTexture("normalMap",A.textures.normalMap),m.setTexture("pbrMap",A.textures.pbrMap),m.setTexture("pbrSGMap",A.textures.pbrSGMap),A.textures.emissiveMap&&m.setTexture("emissiveMap",A.textures.emissiveMap);const{uvTransformBufferTex:b,wrappingRootIndex:U}=P;m.setUniform("wrappingIndex",U),m.setTexture("uvTransformBuffer",b)}function x(A){const{meshes:P,materialIndexMap:b}=A,{bvhBufferInfo:U,transformBufferData:R}=Ga(P,b),E=U.buffer;m.setTexture("transformBuffer",K(e,R,4)),m.setTexture("bvhBuffer",K(e,E,4))}function h(A){c.length=0,A=ne(A,2,8);for(let P=1;P<=A;P++)c.push(2,2,2,2),P>=2&&c.push(1);m.setUniform("bounces",A),p&&(p.strataCount=-1)}function I(A){const{OES_texture_float_linear:P}=l,{environment:b,isTextureEnv:U}=A;if(U){const R=La(b);if(R){const E=z(e,{data:R.data,storage:R.dataFormat,minFilter:P?e.LINEAR:e.NEAREST,magFilter:P?e.LINEAR:e.NEAREST,width:R.width,height:R.height});m.setTexture("envMap",E);const C=va(R);m.setTexture("envMapDistribution",z(e,{data:C.data,storage:"float",width:C.width,height:C.height})),m.setUniform("envMapIntensity",s)}}else{const R=b.data;R&&R.isColor?m.setUniform("backgroundColor",[R.r,R.g,R.b]):m.setUniform("backgroundColor",[0,0,0])}g(n)}function v(A){const{meshLights:P}=A;P&&(m.setUniform("lights.position[0]",P.position),m.setUniform("lights.emission[0]",P.emission),m.setUniform("lights.p1[0]",P.p1),m.setUniform("lights.p2[0]",P.p2),m.setUniform("lights.params[0]",P.params))}function S(A){m.setUniform("envMapIntensity",A)}function g(A){m.setUniform("enviromentVisible",Number(A))}function _(A){m.setTexture("noiseTex",z(e,{data:A,wrapS:e.REPEAT,wrapT:e.REPEAT,storage:"halfFloat"}))}function M(A){m.setUniform("frameCount",A)}function G(){m.setUniform("stratifiedSamples[0]",p.next())}function F(A,P){m.setUniform("jitter",A,P)}function B(A){A>1&&A!==p.strataCount?p=qe(A,c):p.restart(),m.setUniform("strataSize",1/A),G()}function j(A,P){m.setUniform("pixelSize",1/A,1/P)}function fe(A){m.setUniform("camera.transform",A.matrixWorld.elements),m.setUniform("camera.aspect",A.aspect),m.setUniform("camera.fov",.5/Math.tan(.5*Math.PI*A.fov/180)),A.isLensCamera&&(m.setUniform("camera.aperture",A.aperture),m.setUniform("camera.focus",A.focus))}function te({position:A}){m.setTexture("gPosition",A)}function ae(){m.bindTextures()}function N(){m.useProgram(!1),i.draw()}p=qe(1,c);function Z(){ga(),m.dispose()}return{bindTextures:ae,draw:N,outputLocs:m.outputLocs,textures:m.textures,setSize:j,setCamera:fe,setGBuffers:te,setNoise:_,setJitter:F,setFrameCount:M,setStrataCount:B,nextSeed:G,setEnvMapIntensity:S,setEnviromentVisible:g,updateBounces:h,updateEnvLight:I,updateMeshLight:v,updateMeshTransform:x,updateMeshMaterial:L,dispose:Z}}var Ua={source:"in vec3 aPosition;in vec3 aNormal;in vec2 aUv;uniform mat4 projView;uniform mat4 modelMat;uniform mat3 normalMat;out vec3 vPosition;out vec3 vNormal;out vec2 vUv;void main(){vec4 mPosition=modelMat*vec4(aPosition,1.);vPosition=mPosition.xyz;vNormal=normalize(normalMat*aNormal);vUv=aUv;gl_Position=projView*mPosition;}"},Ba={source:`
#define PI 3.14159265359
#define TWOPI 6.28318530718
#define INVPI 0.31830988618
#define INVPI2 0.10132118364
...
#endif
out_position=vec4(vPosition,float(meshIndex)+EPS);out_normal=vec4(normal,LGL_BH);out_color=color;}`};function Fe(e,a,t){if(a===void 0)return;const{itemSize:i,array:o}=t;if(e.enableVertexAttribArray(a),e.bindBuffer(e.ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ARRAY_BUFFER,o,e.STATIC_DRAW),o instanceof Float32Array)e.vertexAttribPointer(a,i,e.FLOAT,!1,0,0);else if(o instanceof Int32Array)e.vertexAttribIPointer(a,i,e.INT,0,0);else throw"Unsupported buffer type"}function ba(e,a,t){const i=t.getAttribute("position").count,o=new he(new Float32Array(3*i),3,!1),r=new he(new Float32Array(2*i),2,!1);Fe(e,a.attribLocs.aPosition,t.getAttribute("position")),Fe(e,a.attribLocs.aNormal,t.getAttribute("normal")||o),Fe(e,a.attribLocs.aUv,t.getAttribute("uv")||r),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ELEMENT_ARRAY_BUFFER,new Uint32Array(t.getIndex().array),e.STATIC_DRAW)}function Ea(e,{materialBuffer:a,uvTransformBuffer:t,decomposedScene:i}){const{meshes:o,materialIndexMap:r}=i,{uvTransformBufferTex:l,wrappingRootIndex:s}=t,n=$(e,{defines:a.defines,vertex:Ua,fragment:Ba});n.setTexture("diffuseMap",a.textures.diffuseMap),n.setTexture("normalMap",a.textures.normalMap),n.setUniform("wrappingIndex",s),n.setTexture("uvTransformBuffer",l);const f=[];for(let _=0;_<o.length;_++){const G=o[_].geometry,F=e.createVertexArray();e.bindVertexArray(F),ba(e,n,G),e.bindVertexArray(null),f.push(F)}let u=0,p=0;function m(_,M){u=_,p=M}let c;function L(_){c=_}let x=new De,h=new we;function I(){x.copy(c.projectionMatrix),x.elements[8]+=2*u,x.elements[9]+=2*p,x.multiply(c.matrixWorldInverse),n.setUniform("projView",x.elements)}function v(){I(),e.enable(e.DEPTH_TEST),e.disable(e.CULL_FACE);for(let _=0;_<o.length;_++){const M=o[_];if(!M.visible)continue;const F=M.geometry.getIndex().count;n.setUniform("modelMat",M.matrixWorld.elements),h.getNormalMatrix(M.matrixWorld),n.setUniform("normalMat",h.elements),n.setUniform("meshIndex",_);const B=r.get(M.material);n.setUniform("materialIndex",B);const j=f[_];e.bindVertexArray(j),n.useProgram(),e.drawElements(e.TRIANGLES,F,e.UNSIGNED_INT,0)}e.enable(e.CULL_FACE),e.disable(e.DEPTH_TEST)}function S(_,M){n.setTexture("diffuseMap",_.textures.diffuseMap),n.setTexture("normalMap",_.textures.normalMap);const{uvTransformBufferTex:G,wrappingRootIndex:F}=M;n.setUniform("wrappingIndex",F),n.setTexture("uvTransformBuffer",G)}function g(){n.dispose()}return{draw:v,outputLocs:n.outputLocs,setCamera:L,setJitter:m,updateMeshMaterial:S,dispose:g}}var wa={source:`layout(location=0)out vec4 out_color;uniform sampler2D inputBuffer;uniform vec2 resolution;in vec2 vCoord;
#define FXAA_PC 1
