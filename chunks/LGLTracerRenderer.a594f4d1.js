...
ivec2 unpackTexel(int i, int columnsLog2) {
	ivec2 u;
	u.y = i >> columnsLog2; // equivalent to (i / 2^columnsLog2) Divide by the number of lines to get the current line
	u.x = i - (u.y << columnsLog2); // equivalent to (i % 2^columnsLog2) gets the current column
	return u;
}
...
}`;function sa(e,a,t){const i=e.getActiveUniformBlockParameter(a,t,e.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES),o=e.getActiveUniforms(a,i,e.UNIFORM_OFFSET),r=e.getActiveUniforms(a,i,e.UNIFORM_ARRAY_STRIDE),l={};for(let s=0;s<i.length;s++){const{name:n,type:f,size:u}=e.getActiveUniform(a,i[s]);l[n]={type:f,size:u,offset:o[s],stride:r[s]}}return l}function Q(e,a,t,i,o,r,l){const s=Math.min(l.length/r,t);for(let n=0;n<s;n++)for(let f=0;f<r;f++)e[a](i+n*o+f*4,l[r*n+f],!0)}function la(e,a,t){const i=e.getUniformBlockIndex(a,t),o=e.getActiveUniformBlockParameter(a,i,e.UNIFORM_BLOCK_DATA_SIZE),r=sa(e,a,i),l=e.createBuffer();e.bindBuffer(e.UNIFORM_BUFFER,l),e.bufferData(e.UNIFORM_BUFFER,o,e.STATIC_DRAW);const s=new DataView(new ArrayBuffer(o));function n(p,m){if(!r[p])return;const{type:d,size:L,offset:x,stride:S}=r[p];switch(d){case e.FLOAT:Q(s,"setFloat32",L,x,S,1,m);break;case e.FLOAT_VEC2:Q(s,"setFloat32",L,x,S,2,m);break;case e.FLOAT_VEC3:Q(s,"setFloat32",L,x,S,3,m);break;case e.FLOAT_VEC4:Q(s,"setFloat32",L,x,S,4,m);break;case e.INT:Q(s,"setInt32",L,x,S,1,m);break;case e.INT_VEC2:Q(s,"setInt32",L,x,S,2,m);break;case e.INT_VEC3:Q(s,"setInt32",L,x,S,3,m);break;case e.INT_VEC4:Q(s,"setInt32",L,x,S,4,m);break;case e.BOOL:Q(s,"setUint32",L,x,S,1,m);break;default:console.warn("UniformBuffer: Unsupported type")}}function f(p){e.bindBuffer(e.UNIFORM_BUFFER,l),e.bufferSubData(e.UNIFORM_BUFFER,0,s),e.bindBufferBase(e.UNIFORM_BUFFER,p,l)}function u(){e.deleteBuffer(l)}return{set:n,bind:f,dispose:u}}function fa(e,a){const t={};for(const i of a){const o=[];t[i]={indices:qe(e,i,o),textures:o}}return t}function Ce(e,a){const t={textures:[],indices:{}};for(const i of a)t.indices[i]=qe(e,i,t.textures);return t}function qe(e,a,t){const i=[];for(const o of e)if(!(o[a]&&o[a].image))i.push(-1);else{let l=t.length;for(let s=0;s<t.length;s++)if(t[s]===o[a]){l=s;break}l===t.length&&t.push(o[a]),i.push(l)}return i}function ua(e){const a={width:0,height:0};for(const i of e)a.width=Math.max(a.width,i.width),a.height=Math.max(a.height,i.height);const t=[];for(const i of e)t.push(i.width/a.width),t.push(i.height/a.height);return{maxSize:a,relativeSizes:t}}function C(...e){let a=0;for(let i=0;i<e.length;i++){const o=e[i],r=o.data?o.data.length/o.channels:0;a=Math.max(a,r)}const t=[];for(let i=0;i<a;i++)for(let o=0;o<e.length;o++){const{data:r=[],channels:l}=e[o];for(let s=0;s<l;s++)t.push(r[i*l+s])}return t}function da(e,a,t){const i=la(e,a,"Materials");return i.set("Materials.colorAndMaterialType[0]",C({data:[].concat(...t.color.map(o=>o.toArray())),channels:3},{data:t.type,channels:1})),i.set("Materials.roughnessMetalnessNormalScale[0]",C({data:t.roughness,channels:1},{data:t.metalness,channels:1},{data:[].concat(...t.normalScale.map(o=>o.toArray())),channels:2})),i.set("Materials.alphaSpecularTintSheenSheenTint[0]",C({data:t.alpha,channels:1},{data:t.specularTint,channels:1},{data:t.sheen,channels:1},{data:t.sheenTint,channels:1})),i.set("Materials.clearcoaRoughnessSubfaceTransmission[0]",C({data:t.clearcoat,channels:1},{data:t.clearcoatRoughness,channels:1},{data:t.subsurface,channels:1},{data:t.transmission,channels:1})),i.set("Materials.iorAtDistanceAnisotropicWorkflow[0]",C({data:t.ior,channels:1},{data:t.atDistance,channels:1},{data:t.anisotropic,channels:1},{data:t.workflow,channels:1})),i.set("Materials.specularColorGlossiness[0]",C({data:[].concat(...t.specularColor.map(o=>o.toArray())),channels:3},{data:t.glossiness,channels:1})),i.set("Materials.extinction[0]",C({data:[].concat(...t.extinction.map(o=>o.toArray())),channels:3},{data:t.anisotropic,channels:1})),i.set("Materials.diffuseNormalRoughnessMetalnessMapIndex[0]",C({data:t.diffuseMapIndex,channels:1},{data:t.normalMapIndex,channels:1},{data:t.roughnessMapIndex,channels:1},{data:t.metalnessMapIndex,channels:1})),i.set("Materials.emissiveSpecularGlossinessMapIndex[0]",C({data:t.emissiveMapIndex,channels:1},{data:t.specularMapIndex,channels:1},{data:t.glossinessMapIndex,channels:1},{data:t.emissiveMapIndex,channels:1})),i.set("Materials.diffuseNormalMapSize[0]",C({data:t.diffuseMapSize,channels:2},{data:t.normalMapSize,channels:2})),i.set("Materials.pbrMapSize[0]",t.pbrMapSize),i.bind(0),i}function Qe(e,a){let t;switch(a){case wt:t=e.CLAMP_TO_EDGE;break;case Et:t=e.REPEAT;break;case bt:t=e.GL_MIRRORED_REPEAT;break}return t}function ie(e,a,t=!1,i=3){const o=a.map(p=>p.image),r=a.map(p=>p.flipY),l=a.map(p=>Qe(e,p.wrapS)),s=a.map(p=>Qe(e,p.wrapT)),{maxSize:n,relativeSizes:f}=ua(o);return{texture:X(e,{width:n.width,height:n.height,gammaCorrection:t,data:o,flipY:r,channels:i,minFilter:e.NEAREST,magFilter:e.NEAREST,wrapS:l,wrapT:s}),relativeSizes:f}}function Oe(e,a){const{materials:t,uvTransformBufferDataLength:i}=a,o=fa(t,["map","normalMap","emissiveMap"]),r=Ce(t,["roughnessMap","metalnessMap"]),l=Ce(t,["specularMap","glossinessMap"]),s={},n={};if(n.color=t.map(d=>d.color),n.roughness=t.map(d=>d.roughness),n.metalness=t.map(d=>d.metalness),n.normalScale=t.map(d=>d.normalScale),n.specularTint=t.map(d=>d.specularTint),n.sheen=t.map(d=>d.sheen),n.sheenTint=t.map(d=>d.sheenTint),n.clearcoat=t.map(d=>d.clearcoat),n.clearcoatRoughness=t.map(d=>d.clearcoatRoughness),n.transmission=t.map(d=>d.transmission),n.subsurface=t.map(d=>d.subsurface),n.ior=t.map(d=>d.ior),n.atDistance=t.map(d=>d.atDistance),n.extinction=t.map(d=>d.extinction),n.alpha=t.map(d=>d.alpha),n.workflow=t.map(d=>d.workflow==="Metalness"?0:1),n.specularColor=t.map(d=>d.specularColor),n.glossiness=t.map(d=>d.glossiness),n.type=t.map(d=>Ut),o.map.textures.length>0){const{relativeSizes:d,texture:L}=ie(e,o.map.textures,!0,4);s.diffuseMap=L,n.diffuseMapSize=d,n.diffuseMapIndex=o.map.indices}if(o.normalMap.textures.length>0){const{relativeSizes:d,texture:L}=ie(e,o.normalMap.textures,!1);s.normalMap=L,n.normalMapSize=d,n.normalMapIndex=o.normalMap.indices}if(r.textures.length>0){const{relativeSizes:d,texture:L}=ie(e,r.textures,!1);s.pbrMap=L,n.pbrMapSize=d,n.roughnessMapIndex=r.indices.roughnessMap,n.metalnessMapIndex=r.indices.metalnessMap}if(l.textures.length>0){const{relativeSizes:d,texture:L}=ie(e,l.textures,!1,4);s.pbrSGMap=L,n.pbrMapSize=d,n.specularMapIndex=l.indices.specularMap,n.glossinessMapIndex=l.indices.glossinessMap}if(o.emissiveMap.textures.length>0){const{relativeSizes:d,texture:L}=ie(e,o.emissiveMap.textures,!0);s.emissiveMap=L,n.pbrMapSize||(n.pbrMapSize=d),n.emissiveMapIndex=o.emissiveMap.indices}const f={NUM_MATERIALS:t.length,NUM_DIFFUSE_MAPS:o.map.textures.length,NUM_NORMAL_MAPS:o.normalMap.textures.length,NUM_DIFFUSE_NORMAL_MAPS:Math.max(o.map.textures.length,o.normalMap.textures.length),NUM_PBR_MAPS:r.textures.length,NUM_PBR_SG_MAPS:l.textures.length,NUM_EMISSIVE_MAPS:o.emissiveMap.textures.length,UVTRANSFORM_COLUMNS:ne(i/3).columnsLog,SUPPORTED_MAPS:Fe.length},u=ee(e,{vertex:{source:"void main() {}"},fragment:{includes:[ra],source:"void main() {}"},defines:f}),p=da(e,u.program,n);function m(){u.dispose(),p.dispose()}return{defines:f,textures:s,dispose:m}}function ca(e,a=1){const t=e.length/4,i=new Float32Array(t*3),o=[];for(let r=0;r<255;r++)o[r]=a*Math.pow(2,r-128)/255;for(let r=0;r<t;r++){const l=e[4*r],s=e[4*r+1],n=e[4*r+2],f=e[4*r+3],u=o[f];i[3*r]=l*u,i[3*r+1]=s*u,i[3*r+2]=n*u}return i}function pa(e){const a=document.createElement("canvas"),t=a.getContext("2d");return a.width=e.width,a.height=e.height,t.drawImage(e,0,0),t.getImageData(0,0,a.width,a.height).data}function ma(e){let a;if(a={width:e.data.image.width,height:e.data.image.height,data:e.data.image.data,dataFormat:"float"},e.data.type===zt?a.data?a.data=ca(a.data,e.intensity):(a.data=pa(e.data.image),a.dataFormat="byte"):e.data.type==Dt?console.error("Please use 'new RGBELoader().setDataType(THREE.FloatType)' to load hdr env map. Half-Float type will loss of precision and have an impression of the effect."):e.data.type!==ze&&console.error(`No support environmentLight's data type: ${e.data.type.toString()}`),e.data.type===ze&&e.data.format===Xt){const t=e.data.image.data,i=t.length/4,o=new Float32Array(i*3);for(let r=0;r<i;r++)o[r*3+0]=t[r*4+0],o[r*3+1]=t[r*4+1],o[r*3+2]=t[r*4+2];a.data=o}return a}function La(e){let a;return e&&e.data&&e.data.isTexture?a=ma(e):console.warn(`No support environment type: ${e.data}`),a}function xa(e,a,t){const i=new Float32Array(t*e*a);return{set(o,r,l,s){i[t*(r*e+o)+l]=s},get(o,r,l){return i[t*(r*e+o)+l]},width:e,height:a,channels:t,array:i}}function va(e){const a=e.data,t={width:e.width+2,height:e.height+1},i=xa(t.width,t.height,2);for(let r=0;r<e.height;r++){const l=Math.sin(Math.PI*(r+.5)/e.height);for(let n=0;n<e.width;n++){const f=3*(r*e.width+n);let u=a[f],p=a[f+1],m=a[f+2],d=.2126*u+.7152*p+.0722*m;d*=l,i.set(n+2,r,0,i.get(n+1,r,0)+d/e.width),i.set(n+1,r,1,d)}const s=i.get(t.width-1,r,0);for(let n=1;n<i.width;n++)i.set(n,r,0,i.get(n,r,0)/s),i.set(n,r,1,i.get(n,r,1)/s);i.set(0,r+1,0,i.get(0,r,0)+s/e.height),i.set(0,r,1,s)}const o=i.get(0,i.height-1,0);for(let r=0;r<i.height;r++)i.set(0,r,0,i.get(0,r,0)/o),i.set(0,r,1,i.get(0,r,1)/o);return t.data=i.array,t}var _a={source:e=>`
...
#endif
int nodesToVisit[MAX_DEPTH];nodesToVisit[0]=tlasIndex;int LGL_BU=0;bool LGL_BV=false;mat4 LGL_BW;mat4 LGL_BWInverse;Ray LGL_BX;LGL_Bc(LGL_BX,ray);int stack=0;while(stack>=0){int i=nodesToVisit[stack--];if(LGL_BV&&i==-1){LGL_BV=false;LGL_Bc(LGL_BX,ray);continue;}vec4 r1=LGL_AY(bvhBuffer,i,BVH_COLUMNS);vec4 r2=LGL_AY(bvhBuffer,i+1,BVH_COLUMNS);int splitAxisOrNumPrimitives=int(r1.w);if(splitAxisOrNumPrimitives>0){int splitAxis=splitAxisOrNumPrimitives-1;Box bbox=Box(r1.xyz,r2.xyz);if(LGL_l(LGL_BX,bbox)>0.0){if(LGL_BX.d[splitAxis]>0.0){nodesToVisit[++stack]=int(r2.w);nodesToVisit[++stack]=i+2;}else{nodesToVisit[++stack]=i+2;nodesToVisit[++stack]=int(r2.w);}}}else if(splitAxisOrNumPrimitives<0){ivec3 index=ivec3(r1.xyz);Triangle tri=Triangle(LGL_AY(positionBuffer,index.x,VERTEX_COLUMNS).xyz,LGL_AY(positionBuffer,index.y,VERTEX_COLUMNS).xyz,LGL_AY(positionBuffer,index.z,VERTEX_COLUMNS).xyz);TriangleIntersect LGL_BK=LGL_k(LGL_BX,tri);if(LGL_BK.t>0.0&&LGL_BK.t<maxDist){return true;}}else{int visible=int(r2.x);if(visible==0){continue;}int instanceID=int(r1.z);vec4 LGL_BY=LGL_AY(transformBuffer,instanceID*4+0,TRANSFORM_COLUMNS).xyzw;vec4 LGL_BZ=LGL_AY(transformBuffer,instanceID*4+1,TRANSFORM_COLUMNS).xyzw;vec4 LGL_Ba=LGL_AY(transformBuffer,instanceID*4+2,TRANSFORM_COLUMNS).xyzw;vec4 LGL_Bb=LGL_AY(transformBuffer,instanceID*4+3,TRANSFORM_COLUMNS).xyzw;LGL_BW=mat4(LGL_BY,LGL_BZ,LGL_Ba,LGL_Bb);LGL_BWInverse=inverse(LGL_BW);LGL_BX.o=vec3(LGL_BWInverse*vec4(ray.o,1.0));LGL_BX.d=vec3(LGL_BWInverse*vec4(ray.d,0.0));nodesToVisit[++stack]=-1;nodesToVisit[++stack]=int(r1.x);LGL_BV=true;LGL_BU=int(r1.y);continue;}}return false;}void LGL_n(inout Ray ray,inout SurfaceInteraction si,inout LightSampleRec lightSampleRec,int bounce){si.LGL_BK=false;float t=INF;float d;
#if defined(NUM_LIGHTS)
...
#endif
}if(si.LGL_BI){path.li+=LGL_Ag(path.ray,depth,lightSampleRec,bsdfSampleRec)*path.beta;path.LGL_BQ=true;return;}if(dot(si.normal,si.LGL_BL)>0.0){path.LGL_BS=vec3(0.0);}path.li+=path.beta*si.emissive;path.beta*=exp(-path.LGL_BS*si.t);MaterialSamples LGL_AQomSamples=getRandomMaterialSamples();if(si.LGL_BH==DISNEY){path.li+=LGL_e(si,path,LGL_AQomSamples.s1,LGL_AQomSamples.s2)*path.beta;}bsdfSampleRec.f=LGL_W(si,-path.ray.d,si.LGL_BL,bsdfSampleRec.L,bsdfSampleRec.pdf,LGL_AQomSamples);if(dot(si.LGL_BL,bsdfSampleRec.L)<0.0){path.LGL_BS=-log(si.extinction)/si.LGL_BE;}if(bsdfSampleRec.pdf>0.0){path.beta*=bsdfSampleRec.f/bsdfSampleRec.pdf;}else{path.LGL_BQ=true;return;}if(depth>=2){float q=1.0-LGL_AV(path.beta);if(LGL_AQomSample()<q){path.LGL_BQ=true;return;}path.beta/=1.0-q;}LGL_AW(path.ray,si.position+EPS*bsdfSampleRec.L,bsdfSampleRec.L);}vec4 LGL_Ao(inout Ray ray){SurfaceInteraction si;Path path;BsdfSampleRec bsdfSampleRec;LightSampleRec lightSampleRec;path.ray=ray;path.li=vec3(0);path.alpha=1.0;path.LGL_BQ=false;path.LGL_BR=1.0;path.LGL_BS=vec3(0.0);path.beta=vec3(1.0);for(int i=0;i<bounces;i++){if(path.LGL_BQ){return vec4(path.li,path.alpha);}LGL_n(path.ray,si,lightSampleRec,i);LGL_o(path.ray,si,lightSampleRec,i);bounce(path,i,si,bsdfSampleRec,lightSampleRec);}return vec4(path.li,path.alpha);}void main(){LGL_AS(frameCount);vec2 vCoordAntiAlias=vCoord+jitter;vec3 direction=normalize(vec3(vCoordAntiAlias-0.5,-1.0)*vec3(camera.aspect,1.0,camera.fov));vec3 origin=camera.transform[3].xyz;direction=mat3(camera.transform)*direction;Ray cam;LGL_AW(cam,origin,direction);vec4 liAndAlpha=LGL_Ao(cam);if(!(liAndAlpha.x<INF&&liAndAlpha.x>-EPS)){liAndAlpha=vec4(0,0,0,1);}out_light=liAndAlpha;}`};function Aa(e,a){const t=[],i=e**a;for(let n=0;n<i;n++)t[n]=n;let o=t.length;const r=[];function l(){o=0}function s(){o>=t.length&&(Vt(t),l());let n=t[o++];for(let f=0;f<a;f++)r[f]=n%e+Math.random(),n=Math.floor(n/e);return r}return{next:s,restart:l,strataCount:e}}function Ye(e,a){const t=[];for(const l of a)t.push(Aa(e,l));const i=[];function o(){let l=0;for(const s of t){const n=s.next();for(const f of n)i[l++]=f}return i}function r(){for(const l of t)l.restart()}return{next:o,restart:r,strataCount:e}}let re=[],se=0,me=[];function Ke(e,a){const t=[],i=[];let o=1;const r={x:1,y:2,z:3},l=(s,n=1)=>{if(o=Math.max(n,o),s.primitives)for(let f=0;f<s.primitives.length;f++){const u=s.primitives[f];if(u.indices!==void 0){const p=me[u.meshID];t.push(u.indices[0]+p,u.indices[1]+p,u.indices[2]+p,s.primitives.length,u.faceNormal.x,u.faceNormal.y,u.faceNormal.z,u.meshID)}else t.push(re[u.meshID],u.materialID,u.meshID,0,u.visible,.1,.1,0);i.push(!1)}else{const f=s.bounds;t.push(f.min.x,f.min.y,f.min.z,r[s.splitAxis],f.max.x,f.max.y,f.max.z,null);const u=t.length-1;i.push(!0),l(s.child0,n+1),t[u]=t.length/4+a,l(s.child1,n+1)}};return l(e),{maxDepth:o,count:t.length/4,flatData:t,isBounds:i}}function ha(){re=[],se=0,me=[]}function je(e,a){return Ke(e,se)}function Sa(e,a,t){const i=[];re=[],me=[];let o=0,r=0,l=0,s=1;for(let n=0;n<e.length;n++){const f=e[n],u=a[n].geometry;me.push(r);const p=Ke(f,o);s=Math.max(p.maxDepth,s),re.push(o),o+=p.count,i.push(p),r+=u.getAttribute("position").count,l+=p.flatData.length}return{totalBLASDataNum:l,totalBLASCount:o,flatBVHInfos:i,maxDepth:s}}function Ma(e,a){const t=e.totalBLASDataNum,i=e.flatBVHInfos,o=a,r=o.flatData.length,l=t+r,s=new ArrayBuffer(4*l),n=new Float32Array(s);for(let m=0;m<i.length;m++){const d=i[m],L=re[m]*4,{flatData:x,isBounds:S}=d;for(let I=0;I<S.length;I++){let v=8*I,h=v+L;S[I]?(n[h]=x[v],n[h+1]=x[v+1],n[h+2]=x[v+2],n[h+3]=x[v+3]):(n[h]=x[v],n[h+1]=x[v+1],n[h+2]=x[v+2],n[h+3]=-x[v+3]),n[h+4]=x[v+4],n[h+5]=x[v+5],n[h+6]=x[v+6],n[h+7]=x[v+7]}}const{flatData:f,isBounds:u}=o,p=se*4;for(let m=0;m<u.length;m++){let d=8*m,L=d+p;u[m],n[L]=f[d],n[L+1]=f[d+1],n[L+2]=f[d+2],n[L+3]=f[d+3],n[L+4]=f[d+4],n[L+5]=f[d+5],n[L+6]=f[d+6],n[L+7]=f[d+7]}return{bvhBufferDataNum:l,buffer:n}}function Ta(e,a,t,i){const o=Sa(e,t);se=o.totalBLASCount;const r=je(a),{bvhBufferDataNum:l,buffer:s}=Ma(o,r);return{maxDepth:o.maxDepth+r.maxDepth,count:l/4,buffer:s,tlasRootIndex:se}}let $,Le;function Fa(e){const a=e.getAttribute("position");if(!a){console.warn("No position attribute");return}const t=new Uint32Array(a.count);for(let i=0;i<t.length;i++)t[i]=i;return e.setIndex(new Me(t,1,!1)),e}function Ia(e){let a=0,t=0;for(let o=0;o<e.length;o++){const r=e[o];r.geometry.isBufferGeometry||(r.geometry=new Ct().fromGeometry(r.geometry));const l=r.geometry;l.getIndex()||Fa(l),l.getAttribute("normal")?l.normalizeNormals():l.computeVertexNormals(),a+=l.getAttribute("position").count,t+=l.getIndex().count}const i=Qt(e);return{vertexTotalCount:a,indexCount:t,blasBVHs:i}}function Ze(e,a){return Ot(e,a)}function Je(e){const a=new Float32Array(e.length*16);for(let t=0;t<e.length;t++){const i=e[t];i.updateMatrixWorld(!0);const o=i.matrixWorld.elements,r=16;for(let l=0;l<r;l++)a[t*r+l]=o[l]}return a}function ga(){$=null,Le=null,ha()}function Ga(e,a){const t=Ze(e,a),i=je(t),o=Je(e),{flatData:r,isBounds:l}=i,{buffer:s}=$,n=Le*4;for(let f=0;f<l.length;f++){let u=8*f,p=u+n;l[f],s[p]=r[u],s[p+1]=r[u+1],s[p+2]=r[u+2],s[p+3]=r[u+3],s[p+4]=r[u+4],s[p+5]=r[u+5],s[p+6]=r[u+6],s[p+7]=r[u+7]}return{bvhBufferInfo:$,transformBufferData:o}}function Pa(e,a){var u;let t=e;const{vertexTotalCount:i,blasBVHs:o}=Ia(e),r=Ze(t,a);$=Ta(o,r,e),Le=$.tlasRootIndex;const l=new Float32Array(i*4),s=new Float32Array(i*4);let n=0;for(let p=0;p<e.length;p++){const d=e[p].geometry,L=d.getAttribute("position").array,x=d.getAttribute("normal").array,S=(u=d.getAttribute("uv"))==null?void 0:u.array,I=d.getAttribute("position").count;for(let v=0;v<I;v++)l[n+v*4+0]=L[v*3+0],l[n+v*4+1]=L[v*3+1],l[n+v*4+2]=L[v*3+2],l[n+v*4+3]=S?S[v*2+0]:0,s[n+v*4+0]=x[v*3+0],s[n+v*4+1]=x[v*3+1],s[n+v*4+2]=x[v*3+2],s[n+v*4+3]=S?S[v*2+1]:0;n+=I*4}const f=Je(e);return{vertexTotalCount:i,bvhBufferInfo:$,positionBufferData:l,normalBufferData:s,transformBufferData:f,tlasRootIndex:Le}}function Na(e,a){return new Promise(t=>{const i=Pa(e,a);t(i)})}async function ya({decomposedScene:e,fullscreenQuad:a,gl:t,materialBuffer:i,uvTransformBuffer:o,optionalExtensions:r,useWorker:l,loadingCallback:s}){s&&s.onProgress&&typeof s.onProgress=="function"&&s.onProgress("Building BVH...");const{OES_texture_float_linear:n}=r,{camera:f,meshLightsNum:u,isTextureEnv:p,meshes:m,materialIndexMap:d}=e,{uvTransformBufferTex:L,uvTransformBufferDataCount:x,wrappingRootIndex:S}=o,{vertexTotalCount:I,bvhBufferInfo:v,positionBufferData:h,normalBufferData:g,transformBufferData:_,tlasRootIndex:F}=await Na(m,d),P=v,T=ee(t,{defines:Ee({OES_texture_float_linear:n,BVH_COLUMNS:ne(P.count).columnsLog,VERTEX_COLUMNS:ne(I).columnsLog,TRANSFORM_COLUMNS:ne(_.length/4).columnsLog,UVTRANSFORM_COLUMNS:ne(x).columnsLog,SUPPORTED_MAPS:Fe.length,MAX_DEPTH:P.maxDepth,USE_LENS_CAMERA:f.isLensCamera,NUM_LIGHTS:u,CONST_COLOR_ENV:!p},i.defines),fragment:_a,vertex:a.vertexShader});return T.setTexture("diffuseMap",i.textures.diffuseMap),T.setTexture("normalMap",i.textures.normalMap),T.setTexture("pbrMap",i.textures.pbrMap),T.setTexture("pbrSGMap",i.textures.pbrSGMap),i.textures.emissiveMap&&T.setTexture("emissiveMap",i.textures.emissiveMap),T.setTexture("positionBuffer",j(t,h,4)),T.setTexture("normalBuffer",j(t,g,4)),T.setTexture("bvhBuffer",j(t,P.buffer,4)),T.setUniform("tlasIndex",F),T.setTexture("transformBuffer",j(t,_,4)),T.setUniform("wrappingIndex",S),T.setTexture("uvTransformBuffer",L),T}async function Ra(e,{bounces:a,decomposedScene:t,fullscreenQuad:i,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,envMapIntensity:s,enviromentVisible:n,useWorker:f,loadingCallback:u}){let p;const m=await ya({bounces:a,decomposedScene:t,fullscreenQuad:i,gl:e,materialBuffer:o,uvTransformBuffer:r,optionalExtensions:l,useWorker:f,loadingCallback:u}),d=[];S(a),I(t),v(t);function L(A,G){m.setTexture("diffuseMap",A.textures.diffuseMap),m.setTexture("normalMap",A.textures.normalMap),m.setTexture("pbrMap",A.textures.pbrMap),m.setTexture("pbrSGMap",A.textures.pbrSGMap),A.textures.emissiveMap&&m.setTexture("emissiveMap",A.textures.emissiveMap);const{uvTransformBufferTex:b,wrappingRootIndex:B}=G;m.setUniform("wrappingIndex",B),m.setTexture("uvTransformBuffer",b)}function x(A){const{meshes:G,materialIndexMap:b}=A,{bvhBufferInfo:B,transformBufferData:R}=Ga(G,b),E=B.buffer;m.setTexture("transformBuffer",j(e,R,4)),m.setTexture("bvhBuffer",j(e,E,4))}function S(A){d.length=0,A=oe(A,2,8);for(let G=1;G<=A;G++)d.push(2,2,2,2),G>=2&&d.push(1);m.setUniform("bounces",A),p&&(p.strataCount=-1)}function I(A){const{OES_texture_float_linear:G}=l,{environment:b,isTextureEnv:B}=A;if(B){const R=La(b);if(R){const E=X(e,{data:R.data,storage:R.dataFormat,minFilter:G?e.LINEAR:e.NEAREST,magFilter:G?e.LINEAR:e.NEAREST,width:R.width,height:R.height});m.setTexture("envMap",E);const V=va(R);m.setTexture("envMapDistribution",X(e,{data:V.data,storage:"float",width:V.width,height:V.height})),m.setUniform("envMapIntensity",s)}}else{const R=b.data;R&&R.isColor?m.setUniform("backgroundColor",[R.r,R.g,R.b]):m.setUniform("backgroundColor",[0,0,0])}g(n)}function v(A){const{meshLights:G}=A;G&&(m.setUniform("lights.position[0]",G.position),m.setUniform("lights.emission[0]",G.emission),m.setUniform("lights.p1[0]",G.p1),m.setUniform("lights.p2[0]",G.p2),m.setUniform("lights.params[0]",G.params))}function h(A){m.setUniform("envMapIntensity",A)}function g(A){m.setUniform("enviromentVisible",Number(A))}function _(A){m.setTexture("noiseTex",X(e,{data:A,wrapS:e.REPEAT,wrapT:e.REPEAT,storage:"halfFloat"}))}function F(A){m.setUniform("frameCount",A)}function P(){m.setUniform("stratifiedSamples[0]",p.next())}function T(A,G){m.setUniform("jitter",A,G)}function H(A){A>1&&A!==p.strataCount?p=Ye(A,d):p.restart(),m.setUniform("strataSize",1/A),P()}function U(A,G){m.setUniform("pixelSize",1/A,1/G)}function le(A){m.setUniform("camera.transform",A.matrixWorld.elements),m.setUniform("camera.aspect",A.aspect),m.setUniform("camera.fov",.5/Math.tan(.5*Math.PI*A.fov/180)),A.isLensCamera&&(m.setUniform("camera.aperture",A.aperture),m.setUniform("camera.focus",A.focus))}function fe({position:A}){m.setTexture("gPosition",A)}function te(){m.bindTextures()}function N(){m.useProgram(!1),i.draw()}p=Ye(1,d);function Z(){ga(),m.dispose()}return{bindTextures:te,draw:N,outputLocs:m.outputLocs,textures:m.textures,setSize:U,setCamera:le,setGBuffers:fe,setNoise:_,setJitter:T,setFrameCount:F,setStrataCount:H,nextSeed:P,setEnvMapIntensity:h,setEnviromentVisible:g,updateBounces:S,updateEnvLight:I,updateMeshLight:v,updateMeshTransform:x,updateMeshMaterial:L,dispose:Z}}var Ba={source:"in vec3 aPosition;in vec3 aNormal;in vec2 aUv;uniform mat4 projView;uniform mat4 modelMat;uniform mat3 normalMat;out vec3 vPosition;out vec3 vNormal;out vec2 vUv;void main(){vec4 mPosition=modelMat*vec4(aPosition,1.);vPosition=mPosition.xyz;vNormal=normalize(normalMat*aNormal);vUv=aUv;gl_Position=projView*mPosition;}"},Ua={source:`
#define PI 3.14159265359
#define TWOPI 6.28318530718
#define INVPI 0.31830988618
#define INVPI2 0.10132118364
...
#endif
out_position=vec4(vPosition,float(meshIndex)+EPS);out_normal=vec4(normal,LGL_BH);out_color=color;}`};function Se(e,a,t){if(a===void 0)return;const{itemSize:i,array:o}=t;if(e.enableVertexAttribArray(a),e.bindBuffer(e.ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ARRAY_BUFFER,o,e.STATIC_DRAW),o instanceof Float32Array)e.vertexAttribPointer(a,i,e.FLOAT,!1,0,0);else if(o instanceof Int32Array)e.vertexAttribIPointer(a,i,e.INT,0,0);else throw"Unsupported buffer type"}function ba(e,a,t){const i=t.getAttribute("position").count,o=new Me(new Float32Array(3*i),3,!1),r=new Me(new Float32Array(2*i),2,!1);Se(e,a.attribLocs.aPosition,t.getAttribute("position")),Se(e,a.attribLocs.aNormal,t.getAttribute("normal")||o),Se(e,a.attribLocs.aUv,t.getAttribute("uv")||r),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,e.createBuffer()),e.bufferData(e.ELEMENT_ARRAY_BUFFER,new Uint32Array(t.getIndex().array),e.STATIC_DRAW)}function Ea(e,{materialBuffer:a,uvTransformBuffer:t,decomposedScene:i}){const{meshes:o,materialIndexMap:r}=i,{uvTransformBufferTex:l,wrappingRootIndex:s}=t,n=ee(e,{defines:a.defines,vertex:Ba,fragment:Ua});n.setTexture("diffuseMap",a.textures.diffuseMap),n.setTexture("normalMap",a.textures.normalMap),n.setUniform("wrappingIndex",s),n.setTexture("uvTransformBuffer",l);const f=[];for(let _=0;_<o.length;_++){const P=o[_].geometry,T=e.createVertexArray();e.bindVertexArray(T),ba(e,n,P),e.bindVertexArray(null),f.push(T)}let u=0,p=0;function m(_,F){u=_,p=F}let d;function L(_){d=_}let x=new ke,S=new We;function I(){x.copy(d.projectionMatrix),x.elements[8]+=2*u,x.elements[9]+=2*p,x.multiply(d.matrixWorldInverse),n.setUniform("projView",x.elements)}function v(){I(),e.enable(e.DEPTH_TEST),e.disable(e.CULL_FACE);for(let _=0;_<o.length;_++){const F=o[_];if(!F.visible)continue;const T=F.geometry.getIndex().count;n.setUniform("modelMat",F.matrixWorld.elements),S.getNormalMatrix(F.matrixWorld),n.setUniform("normalMat",S.elements),n.setUniform("meshIndex",_);const H=r.get(F.material);n.setUniform("materialIndex",H);const U=f[_];e.bindVertexArray(U),n.useProgram(),e.drawElements(e.TRIANGLES,T,e.UNSIGNED_INT,0)}e.enable(e.CULL_FACE),e.disable(e.DEPTH_TEST)}function h(_,F){n.setTexture("diffuseMap",_.textures.diffuseMap),n.setTexture("normalMap",_.textures.normalMap);const{uvTransformBufferTex:P,wrappingRootIndex:T}=F;n.setUniform("wrappingIndex",T),n.setTexture("uvTransformBuffer",P)}function g(){n.dispose()}return{draw:v,outputLocs:n.outputLocs,setCamera:L,setJitter:m,updateMeshMaterial:h,dispose:g}}var wa={source:`layout(location=0)out vec4 out_color;uniform sampler2D inputBuffer;uniform vec2 resolution;in vec2 vCoord;
#define FXAA_PC 1
