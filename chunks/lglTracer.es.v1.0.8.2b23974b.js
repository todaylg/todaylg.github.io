import{c as ft,L as $e,A as ct,d as ut,f as pt,h as na,V as W,C as ne,i as fe,P as mt,j as et,k as xt,B as ye,n as le,U as Lt,H as ht,F as we,o as vt}from"./utils.57a85e8a.js";/**
 * @license
 ...
 */var At=Object.defineProperty,_t=Object.defineProperties,St=Object.getOwnPropertyDescriptors,Qe=Object.getOwnPropertySymbols,gt=Object.prototype.hasOwnProperty,Mt=Object.prototype.propertyIsEnumerable,De=(t,e,a)=>e in t?At(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a,tt=(t,e)=>{for(var a in e||(e={}))gt.call(e,a)&&De(t,a,e[a]);if(Qe)for(var a of Qe(e))Mt.call(e,a)&&De(t,a,e[a]);return t};function Ge(t,e){const a={};for(const n of e)a[n]=t.getExtension(n);return a}function Ft(t,e){const a={},n=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const{name:i}=t.getActiveAttrib(e,r);i&&(a[i]=t.getAttribLocation(e,i))}return a}const Ye=["EXT_color_buffer_float","EXT_float_blend"],It=["OES_texture_float_linear"];function Le(t,{color:e,depth:a}){const n=t.createFramebuffer();function r(){t.bindFramebuffer(t.FRAMEBUFFER,n)}function i(){t.bindFramebuffer(t.FRAMEBUFFER,null)}return function(){r();const o=[];for(let l in e){l=Number(l),l===void 0&&console.error("invalid location");const f=e[l];t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+l,f.target,f.texture,0),o.push(t.COLOR_ATTACHMENT0+l)}t.drawBuffers(o),a&&t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,a.target,a.texture),i()}(),{color:e,bind:r,unbind:i,dispose:function(){t.deleteFramebuffer(n)}}}var Tt={source:"layout(location=0)in vec2 a_position;out vec2 vCoord;void main(){vCoord=a_position;gl_Position=vec4(2.*a_position-1.,0,1);}"};let Ne;function k(t,e){return{values:`uniform${t}${e}`,array:`uniform${t}${e}v`}}function be(t,e){return{matrix:t===e?`uniformMatrix${t}fv`:`uniformMatrix${t}x${e}fv`}}function Gt(t,e){const a=function(o,l){const f={},c=o.getProgramParameter(l,o.ACTIVE_UNIFORMS);for(let d=0;d<c;d++){const{name:s,type:u}=o.getActiveUniform(l,d),L=o.getUniformLocation(l,s);L&&(f[s]={type:u,location:L})}return f}(t,e),n={},r=[];for(let o in a){const{type:l,location:f}=a[o],c={type:l,location:f,v0:0,v1:0,v2:0,v3:0};n[o]=c}const i=new Set;return Ne=Ne||function(o){return{[o.FLOAT]:k(1,"f"),[o.FLOAT_VEC2]:k(2,"f"),[o.FLOAT_VEC3]:k(3,"f"),[o.FLOAT_VEC4]:k(4,"f"),[o.INT]:k(1,"i"),[o.INT_VEC2]:k(2,"i"),[o.INT_VEC3]:k(3,"i"),[o.INT_VEC4]:k(4,"i"),[o.SAMPLER_2D]:k(1,"i"),[o.SAMPLER_2D_ARRAY]:k(1,"i"),[o.FLOAT_MAT2]:be(2,2),[o.FLOAT_MAT3]:be(3,3),[o.FLOAT_MAT4]:be(4,4)}}(t),{setUniform:function(o,l,f,c,d){const s=n[o];s?(s.v0=l,s.v1=f,s.v2=c,s.v3=d,r.push(s)):i.has(o)||i.add(o)},upload:function(){for(;r.length>0;){const{type:o,location:l,v0:f,v1:c,v2:d,v3:s}=r.pop(),u=Ne[o];if(f&&f.length)if(u.matrix){const L=f,p=c||!1;t[u.matrix](l,p,L)}else t[u.array](l,f);else t[u.values](l,f,c,d,s)}}}}function at(t){let e={};for(let a=0;a<t.length;a++)e[t[a]]=a;return e}function nt(t,e,a,n){let r=`#version 300 es
precision mediump float;
precision mediump int;
precision lowp isampler2D;
`;return n&&(r+=function(i){let o="";for(const l in i){const f=i[l];f&&(o+=`#define ${l} ${f}
`)}return o}(n)),e===t.FRAGMENT_SHADER&&a.outputs&&(r+=function(i){let o="";const l=at(i);for(let f in l)o+=`layout(location = ${l[f]}) out vec4 out_${f};
`;return o}(a.outputs)),a.includes&&(r+=function(i,o){let l="";for(let f of i)l+=typeof f=="function"?f(o):f;return l}(a.includes,n)),typeof a.source=="function"?r+=a.source(n):r+=a.source,function(i,o,l){const f=i.createShader(o);if(i.shaderSource(f,l),i.compileShader(f),i.getShaderParameter(f,i.COMPILE_STATUS))return f;const c=l.split(`
`).map((d,s)=>`${s+1}: ${d}`).join(`
`);throw console.log(c),i.getShaderInfoLog(f)}(t,e,r)}function it(t,{defines:e,vertex:a}){return nt(t,t.VERTEX_SHADER,a,e)}function oe(t,e){const{fragment:a,vertex:n}=e,r=n instanceof WebGLShader?n:it(t,e),i=a instanceof WebGLShader?a:function(c,{defines:d,fragment:s}){return nt(c,c.FRAGMENT_SHADER,s,d)}(t,e),o=function(c,d,s,u,L){const p=c.createProgram();if(c.attachShader(p,d),c.attachShader(p,s),u&&c.transformFeedbackVaryings(p,u,L),c.linkProgram(p),c.detachShader(p,d),c.detachShader(p,s),c.getProgramParameter(p,c.LINK_STATUS))return p;throw c.getProgramInfoLog(p)}(t,r,i);return l=tt({},function(c,d){const s=Gt(c,d),u={};let L=1;function p(){for(let h in u){const{tex:m,unit:_}=u[h];c.activeTexture(c.TEXTURE0+_),c.bindTexture(m.target,m.texture)}}return{attribLocs:Ft(c,d),bindTextures:p,program:d,setTexture:function(h,m){if(m)if(u[h])u[h].tex=m;else{const _=L++;s.setUniform(h,_),u[h]={unit:_,tex:m}}},setUniform:s.setUniform,textures:u,useProgram:function(h=!0){c.useProgram(d),s.upload(),h&&p()},dispose:function(){for(const h in u){const{tex:m}=u[h];c.deleteTexture(m.texture)}c.deleteProgram(d)}}}(t,o)),f={outputLocs:a.outputs?at(a.outputs):{}},_t(l,St(f));var l,f}function de(t,e,a){return Math.min(Math.max(t,e),a)}function D(t,e){let{width:a=null,height:n=null,data:r=null,length:i=1,channels:o=null,storage:l=null,flipY:f=!1,gammaCorrection:c=!1,wrapS:d=t.CLAMP_TO_EDGE,wrapT:s=t.CLAMP_TO_EDGE,minFilter:u=t.NEAREST,magFilter:L=t.NEAREST}=e;a=a||r.width||0,n=n||r.height||0;const p=t.createTexture();let h,m;Array.isArray(r)&&(m=r,r=m[0]),h=m||i>1?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D,t.activeTexture(t.TEXTURE0),t.bindTexture(h,p),t.texParameteri(h,t.TEXTURE_WRAP_S,d),t.texParameteri(h,t.TEXTURE_WRAP_T,s),t.texParameteri(h,t.TEXTURE_MIN_FILTER,u),t.texParameteri(h,t.TEXTURE_MAG_FILTER,L),o||(o=r&&r.length?r.length/(a*n):4),o=de(o,1,4);const{type:_,format:g,internalFormat:v}=function(A,M,F,N,y){let b,V;const se=N instanceof Uint8Array||N instanceof HTMLImageElement||N instanceof HTMLCanvasElement||N instanceof ImageData||N instanceof ImageBitmap,j=N instanceof Float32Array;return F==="byte"||!F&&se?(V={1:A.R8,2:A.RG8,3:y?A.SRGB8:A.RGB8,4:y?A.SRGB8_ALPHA8:A.RGBA8}[M],b=A.UNSIGNED_BYTE):F==="float"||!F&&j?(V={1:A.R32F,2:A.RG32F,3:A.RGB32F,4:A.RGBA32F}[M],b=A.FLOAT):F==="halfFloat"?(V={1:A.R16F,2:A.RG16F,3:A.RGB16F,4:A.RGBA16F}[M],b=A.HALF_FLOAT):F==="snorm"&&(V={1:A.R8_SNORM,2:A.RG8_SNORM,3:A.RGB8_SNORM,4:A.RGBA8_SNORM}[M],b=A.UNSIGNED_BYTE),{format:Nt(A,M),internalFormat:V,type:b}}(t,o,l,r,c);if(m){t.texStorage3D(h,1,v,a,n,m.length);for(let A=0;A<m.length;A++){const M=m[A].width||a,F=m[A].height||n;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,Array.isArray(f)?f[A]:f),t.texSubImage3D(h,0,0,0,A,M,F,1,g,_,m[A])}}else i>1?t.texStorage3D(h,1,v,a,n,i):(t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,f),t.texStorage2D(h,1,v,a,n),r&&t.texSubImage2D(h,0,0,0,a,n,g,_,r));return t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),{target:h,texture:p}}function Nt(t,e){return{1:t.RED,2:t.RG,3:t.RGB,4:t.RGBA}[e]}class bt extends ft{constructor(){super(),this.materialType=null,this.isRayTracingMaterial=!0}copy(e){super.copy(e),this.materialType=e.materialType,this.isRayTracingMaterial=e.isRayTracingMaterial}}class We extends bt{constructor(e){super(),this.materialType="Disney",this.workflow="Metalness",this.color=new ne(16777215),this.roughness=.5,this.metalness=0,this.map=null,this.emissive=new ne(0),this.emissiveMap=null,this.normalMap=null,this.normalScale=new fe(1,1),this.roughnessMap=null,this.metalnessMap=null,this.specularTint=0,this.sheen=0,this.sheenTint=.5,this.clearcoat=0,this.clearcoatRoughness=0,this.subsurface=0,this.alpha=1,this.ior=1.5,this.transmission=0,this.atDistance=1,this.extinction=new ne(16777215),this.anisotropic=0,this.specularColor=new ne(16777215),this.glossiness=1,this.specularMap=null,this.glossinessMap=null,this.setValues(e)}copy(e){return this.color=new ne().copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.emissive=new ne().copy(e.emissive),this.emissiveMap=e.emissiveMap,this.normalMap=e.normalMap,this.normalScale=new fe().copy(e.normalScale),this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.specularTint=e.specularTint,this.sheen=e.sheen,this.sheenTint=e.sheenTint,this.clearcoat=e.clearcoat,this.clearcoatRoughness=e.clearcoatRoughness,this.subsurface=e.subsurface,this.transmission=e.transmission,this.ior=e.ior,this.atDistance=e.atDistance,this.anisotropic=e.anisotropic,this.extinction=new ne().copy(e.extinction),this.alpha=e.alpha,this}clone(){return new this.constructor().copy(this)}fromBasicMaterial(e){return this.name=e.name,e.color&&this.color.copy(e.color),e.map&&(this.map=e.map),this}fromStandardMaterial(e){return this.name=e.name,this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.transmission=e.transmission||0,this.ior=e.ior||1.5,this.clearcoat=e.clearcoat||0,this.clearcoatRoughness=e.clearcoatRoughness||0,this.sheen=e.sheen||0,this.sheenTint=e.sheenTint||.5,this.alpha=e.opacity,this.map=e.map,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.normalMap=e.normalMap,this.normalScale.copy(e.normalScale),this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,e.isGLTFSpecularGlossinessMaterial&&(this.workflow="Specular",this.specularColor.copy(e.specular),this.glossiness=e.glossiness,this.specularMap=e.specularMap,this.glossinessMap=e.glossinessMap),this}}function Pt(t){const e={};return e.position=t.map(a=>a.position),e.emission=t.map(a=>a.emission),e.p1=t.map(a=>a.p1),e.p2=t.map(a=>a.p2),e.radius=t.map(a=>a.radius),e.area=t.map(a=>a.area),e.type=t.map(a=>a.type),e.visible=t.map(a=>a.visible),e.position=[].concat(...e.position.map(a=>a.toArray())),e.emission=[].concat(...e.emission.map(a=>a.toArray())),e.p1=[].concat(...e.p1.map(a=>a.toArray())),e.p2=[].concat(...e.p2.map(a=>a.toArray())),e.params=function(...a){let n=0;for(let i=0;i<a.length;i++){const o=a[i],l=o.data?o.data.length/o.channels:0;n=Math.max(n,l)}const r=[];for(let i=0;i<n;i++)for(let o=0;o<a.length;o++){const{data:l=[],channels:f}=a[o];for(let c=0;c<f;c++)r.push(l[i*f+c])}return r}({data:e.radius,channels:1},{data:e.area,channels:1},{data:e.type,channels:1},{data:e.visible,channels:1}),e}function _e(t,e){const a=[],n=[];t.traverse(c=>{c.isMesh&&(c.geometry?c.material?(c.material.isMeshStandardMaterial?c.material=new We().fromStandardMaterial(c.material):c.material.isRayTracingMaterial||(c.material=new We().fromBasicMaterial(c.material)),a.push(c)):console.warn(c,"must have a material property."):console.warn(c,"must have a geometry property")),c.isLight&&n.push(c)});const r={data:t.environment,intensity:t.envMapIntensity||1},i=r.data&&r.data.isTexture,o=n.length||0;let l=null;o&&(l=function(c){return Pt(c.map(d=>{const s={};switch(s.position=d.position,s.emission=d.color.multiplyScalar(d.intensity),s.radius=d.radius||0,s.area=0,s.visible=Number(d.visible),s.p1=new W,s.p2=new W,d.type){case"RectAreaLight":if(s.type=0,d.width&&d.height){const u=new xt(d.width,d.height),L=new W;d.target&&L.copy(d.target);const p=new W().subVectors(d.position,L),h=new W().copy(p).negate();u.lookAt(h);const m=u.attributes.position.array,_=new W(m[0],m[1],m[2]).add(d.position);new W(m[3],m[4],m[5]).add(d.position);const g=new W(m[6],m[7],m[8]).add(d.position),v=new W(m[9],m[10],m[11]).add(d.position);s.position.copy(g),s.p1=v.sub(g),s.p2=_.sub(g),s.area=new W().crossVectors(s.p1,s.p2).length()}break;case"QuadLight":s.type=1,s.p1=d.v1.sub(d.position),s.p2=d.v2.sub(d.position),s.area=new W().crossVectors(s.p1,s.p2).length();break;case"SphereAreaLight":s.type=2,s.area=4*Math.PI*d.radius*d.radius;break;case"PointLight":s.type=4,s.area=0;break;case"DirectionalLight":s.type=3,d.target&&s.p1.copy(d.target),s.area=0;break;default:console.warn(`Not support light type: ${d.type}`)}return s}))}(n));const f=new Map;for(const c of a){if(!c.visible)continue;const d=c.material;let s=f.get(d);s===void 0&&(s=f.size,f.set(d,s))}return{environment:r,isTextureEnv:i,camera:e,meshes:a,meshLights:l,meshLightsNum:o,materialIndexMap:f,materials:Array.from(f.keys())}}function yt(t,e){const a=new ye;for(const r of e){const i=t.getAttribute(r);i&&(typeof a.setAttribute!="function"&&(a.setAttribute=a.addAttribute),a.setAttribute(r,i.clone()))}const n=t.getIndex();return n&&a.setIndex(n),a}function Rt(t){const e=t.getAttribute("position");if(!e)return void console.warn("No position attribute");const a=new Uint32Array(e.count);for(let n=0;n<a.length;n++)a[n]=n;return t.setIndex(new le(a,1,!1)),t}function Et(t,e){let a=0,n=0;const r=[];for(const o of t){if(!o.visible)continue;const l=o.geometry.isBufferGeometry?yt(o.geometry,["position","normal","uv"]):new ye().fromGeometry(o.geometry);l.getIndex()||Rt(l),l.applyMatrix4?l.applyMatrix4(o.matrixWorld):l.applyMatrix(o.matrixWorld),l.getAttribute("normal")?l.normalizeNormals():l.computeVertexNormals(),a+=l.getAttribute("position").count,n+=l.getIndex().count;const f=o.material;let c=e.get(f);r.push({geometry:l,materialIndex:c})}return{geometry:function(o,l,f){const c=new le(new Float32Array(3*l),3,!1),d=new le(new Float32Array(3*l),3,!1),s=new le(new Float32Array(2*l),2,!1),u=new le(new Int32Array(2*l),2,!1),L=new le(new Uint32Array(f),1,!1),p=new ye;typeof p.setAttribute!="function"&&(p.setAttribute=p.addAttribute),p.setAttribute("position",c),p.setAttribute("normal",d),p.setAttribute("uv",s),p.setAttribute("materialMeshIndex",u),p.setIndex(L);let h=0,m=0,_=1;for(const{geometry:g,materialIndex:v}of o){const A=g.getAttribute("position").count;p.merge(g,h);const M=g.getIndex();for(let F=0;F<M.count;F++)L.setX(m+F,h+M.getX(F));for(let F=0;F<A;F++)u.setXY(h+F,v,_);h+=A,m+=M.count,_++}return p}(r,a,n)}}function q(t,e,a,n,r,i,o){const l=Math.min(o.length/i,a);for(let f=0;f<l;f++)for(let c=0;c<i;c++)t[e](n+f*r+4*c,o[i*f+c],!0)}function He(t,e){const a={textures:[],indices:{}};for(const n of e)a.indices[n]=ot(t,n,a.textures);return a}function ot(t,e,a){const n=[];for(const r of t)if(r[e]&&r[e].image){let i=a.length;for(let o=0;o<a.length;o++)if(a[o]===r[e]){i=o;break}i===a.length&&a.push(r[e]),n.push(i)}else n.push(-1);return n}function Z(...t){let e=0;for(let n=0;n<t.length;n++){const r=t[n],i=r.data?r.data.length/r.channels:0;e=Math.max(e,i)}const a=[];for(let n=0;n<e;n++)for(let r=0;r<t.length;r++){const{data:i=[],channels:o}=t[r];for(let l=0;l<o;l++)a.push(i[n*o+l])}return a}function Ut(t,e,a){const n=function(r,i,o){const l=r.getUniformBlockIndex(i,o),f=r.getActiveUniformBlockParameter(i,l,r.UNIFORM_BLOCK_DATA_SIZE),c=function(u,L,p){const h=u.getActiveUniformBlockParameter(L,p,u.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES),m=u.getActiveUniforms(L,h,u.UNIFORM_OFFSET),_=u.getActiveUniforms(L,h,u.UNIFORM_ARRAY_STRIDE),g={};for(let v=0;v<h.length;v++){const{name:A,type:M,size:F}=u.getActiveUniform(L,h[v]);g[A]={type:M,size:F,offset:m[v],stride:_[v]}}return g}(r,i,l),d=r.createBuffer();r.bindBuffer(r.UNIFORM_BUFFER,d),r.bufferData(r.UNIFORM_BUFFER,f,r.STATIC_DRAW);const s=new DataView(new ArrayBuffer(f));return{set:function(u,L){if(!c[u])return;const{type:p,size:h,offset:m,stride:_}=c[u];switch(p){case r.FLOAT:q(s,"setFloat32",h,m,_,1,L);break;case r.FLOAT_VEC2:q(s,"setFloat32",h,m,_,2,L);break;case r.FLOAT_VEC3:q(s,"setFloat32",h,m,_,3,L);break;case r.FLOAT_VEC4:q(s,"setFloat32",h,m,_,4,L);break;case r.INT:q(s,"setInt32",h,m,_,1,L);break;case r.INT_VEC2:q(s,"setInt32",h,m,_,2,L);break;case r.INT_VEC3:q(s,"setInt32",h,m,_,3,L);break;case r.INT_VEC4:q(s,"setInt32",h,m,_,4,L);break;case r.BOOL:q(s,"setUint32",h,m,_,1,L);break;default:console.warn("UniformBuffer: Unsupported type")}},bind:function(u){r.bindBuffer(r.UNIFORM_BUFFER,d),r.bufferSubData(r.UNIFORM_BUFFER,0,s),r.bindBufferBase(r.UNIFORM_BUFFER,u,d)},dispose:function(){r.deleteBuffer(d)}}}(t,e,"Materials");return n.set("Materials.colorAndMaterialType[0]",Z({data:[].concat(...a.color.map(r=>r.toArray())),channels:3},{data:a.type,channels:1})),n.set("Materials.roughnessMetalnessNormalScale[0]",Z({data:a.roughness,channels:1},{data:a.metalness,channels:1},{data:[].concat(...a.normalScale.map(r=>r.toArray())),channels:2})),n.set("Materials.alphaSpecularTintSheenSheenTint[0]",Z({data:a.alpha,channels:1},{data:a.specularTint,channels:1},{data:a.sheen,channels:1},{data:a.sheenTint,channels:1})),n.set("Materials.clearcoaRoughnessSubfaceTransmission[0]",Z({data:a.clearcoat,channels:1},{data:a.clearcoatRoughness,channels:1},{data:a.subsurface,channels:1},{data:a.transmission,channels:1})),n.set("Materials.iorAtDistanceAnisotropicWorkflow[0]",Z({data:a.ior,channels:1},{data:a.atDistance,channels:1},{data:a.anisotropic,channels:1},{data:a.workflow,channels:1})),n.set("Materials.specularColorGlossiness[0]",Z({data:[].concat(...a.specularColor.map(r=>r.toArray())),channels:3},{data:a.glossiness,channels:1})),n.set("Materials.extinction[0]",Z({data:[].concat(...a.extinction.map(r=>r.toArray())),channels:3},{data:a.anisotropic,channels:1})),n.set("Materials.diffuseNormalRoughnessMetalnessMapIndex[0]",Z({data:a.diffuseMapIndex,channels:1},{data:a.normalMapIndex,channels:1},{data:a.roughnessMapIndex,channels:1},{data:a.metalnessMapIndex,channels:1})),n.set("Materials.emissiveSpecularGlossinessMapIndex[0]",Z({data:a.emissiveMapIndex,channels:1},{data:a.specularMapIndex,channels:1},{data:a.glossinessMapIndex,channels:1},{data:a.emissiveMapIndex,channels:1})),n.set("Materials.diffuseNormalMapSize[0]",Z({data:a.diffuseMapSize,channels:2},{data:a.normalMapSize,channels:2})),n.set("Materials.pbrMapSize[0]",a.pbrMapSize),n.bind(0),n}function xe(t,e,a=!1,n=3){const r=e.map(f=>f.image),i=e.map(f=>f.flipY),{maxSize:o,relativeSizes:l}=function(f){const c={width:0,height:0};for(const s of f)c.width=Math.max(c.width,s.width),c.height=Math.max(c.height,s.height);const d=[];for(const s of f)d.push(s.width/c.width),d.push(s.height/c.height);return{maxSize:c,relativeSizes:d}}(r);return{texture:D(t,{width:o.width,height:o.height,gammaCorrection:a,data:r,flipY:i,channels:n,minFilter:t.LINEAR,magFilter:t.LINEAR}),relativeSizes:l}}function Oe(t,e){const a=function(d,s){const u={};for(const L of s){const p=[];u[L]={indices:ot(d,L,p),textures:p}}return u}(e,["map","normalMap","emissiveMap"]),n=He(e,["roughnessMap","metalnessMap"]),r=He(e,["specularMap","glossinessMap"]),i={},o={};if(o.color=e.map(d=>d.color),o.roughness=e.map(d=>d.roughness),o.metalness=e.map(d=>d.metalness),o.normalScale=e.map(d=>d.normalScale),o.specularTint=e.map(d=>d.specularTint),o.sheen=e.map(d=>d.sheen),o.sheenTint=e.map(d=>d.sheenTint),o.clearcoat=e.map(d=>d.clearcoat),o.clearcoatRoughness=e.map(d=>d.clearcoatRoughness),o.transmission=e.map(d=>d.transmission),o.subsurface=e.map(d=>d.subsurface),o.ior=e.map(d=>d.ior),o.atDistance=e.map(d=>d.atDistance),o.extinction=e.map(d=>d.extinction),o.alpha=e.map(d=>d.alpha),o.workflow=e.map(d=>d.workflow==="Metalness"?0:1),o.specularColor=e.map(d=>d.specularColor),o.glossiness=e.map(d=>d.glossiness),o.type=e.map(d=>0),a.map.textures.length>0){const{relativeSizes:d,texture:s}=xe(t,a.map.textures,!0,4);i.diffuseMap=s,o.diffuseMapSize=d,o.diffuseMapIndex=a.map.indices}if(a.normalMap.textures.length>0){const{relativeSizes:d,texture:s}=xe(t,a.normalMap.textures,!1);i.normalMap=s,o.normalMapSize=d,o.normalMapIndex=a.normalMap.indices}if(n.textures.length>0){const{relativeSizes:d,texture:s}=xe(t,n.textures,!1);i.pbrMap=s,o.pbrMapSize=d,o.roughnessMapIndex=n.indices.roughnessMap,o.metalnessMapIndex=n.indices.metalnessMap}if(r.textures.length>0){const{relativeSizes:d,texture:s}=xe(t,r.textures,!1,4);i.pbrSGMap=s,o.pbrMapSize=d,o.specularMapIndex=r.indices.specularMap,o.glossinessMapIndex=r.indices.glossinessMap}if(a.emissiveMap.textures.length>0){const{relativeSizes:d,texture:s}=xe(t,a.emissiveMap.textures,!0);i.emissiveMap=s,o.pbrMapSize||(o.pbrMapSize=d),o.emissiveMapIndex=a.emissiveMap.indices}const l={NUM_MATERIALS:e.length,NUM_DIFFUSE_MAPS:a.map.textures.length,NUM_NORMAL_MAPS:a.normalMap.textures.length,NUM_DIFFUSE_NORMAL_MAPS:Math.max(a.map.textures.length,a.normalMap.textures.length),NUM_PBR_MAPS:n.textures.length,NUM_PBR_SG_MAPS:r.textures.length,NUM_EMISSIVE_MAPS:a.emissiveMap.textures.length},f=oe(t,{vertex:{source:"void main() {}"},fragment:{includes:[`uniform Materials {
...
}`],source:"void main() {}"},defines:l}),c=Ut(t,f.program,o);return{defines:l,textures:i,dispose:function(){f.dispose(),c.dispose()}}}class K{constructor(e=0,a=0,n=0){this.x=e,this.y=a,this.z=n}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)}addVectors(e,a){return this.x=e.x+a.x,this.y=e.y+a.y,this.z=e.z+a.z,this}subVectors(e,a){return this.x=e.x-a.x,this.y=e.y-a.y,this.z=e.z-a.z,this}multiplyScalar(e){return this.x*=e,this.y*=e,this.z*=e,this}divide(e){return this.x/=e.x,this.y/=e.y,this.z/=e.z,this}divideScalar(e){return this.multiplyScalar(1/e)}min(e){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this.z=Math.min(this.z,e.z),this}max(e){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this.z=Math.max(this.z,e.z),this}dot(e){return this.x*e.x+this.y*e.y+this.z*e.z}normalize(){return this.divideScalar(this.length()||1)}crossVectors(e,a){const n=e.x,r=e.y,i=e.z,o=a.x,l=a.y,f=a.z;return this.x=r*f-i*l,this.y=i*o-n*f,this.z=n*l-r*o,this}fromBufferAttribute(e,a,n){return n!==void 0&&console.warn("THREE.Vector3: offset has been removed from .fromBufferAttribute()."),this.x=e.getX(a),this.y=e.getY(a),this.z=e.getZ(a),this}}class ie{constructor(e=new K(1/0,1/0,1/0),a=new K(-1/0,-1/0,-1/0)){this.min=e,this.max=a}isEmpty(){return this.max.x<this.min.x||this.max.y<this.min.y||this.max.z<this.min.z}getCenter(e){return this.isEmpty()?e.set(0,0,0):e.addVectors(this.min,this.max).multiplyScalar(.5)}getSize(e){return this.isEmpty()?e.set(0,0,0):e.subVectors(this.max,this.min)}expandByPoint(e){return this.min.min(e),this.max.max(e),this}union(e){return this.min.min(e.min),this.max.max(e.max),this}}function ke(t,e,a){const n=t[a];t[a]=t[e],t[e]=n}const B=new K;function Ze(t,e){return{primitives:t,bounds:e}}function Ke(t,e,a){let n=a[e]-t.min[e];return t.max[e]>t.min[e]&&(n/=t.max[e]-t.min[e]),n}function Pe(t){return t.getSize(B),2*(B.x*B.z+B.x*B.y+B.z*B.y)}function Re(t,e,a){const n=new ie;for(let f=e;f<a;f++)n.union(t[f].bounds);const r=a-e;if(r===1)return Ze(t.slice(e,a),n);{const f=new ie;for(let s=e;s<a;s++)f.expandByPoint(t[s].center);const c=(f.getSize(B),B.x>B.z?B.x>B.y?"x":"y":B.z>B.y?"z":"y");let d=Math.floor((e+a)/2);if(r<=4)(function(s,u,L=0,p=s.length,h=Math.floor((L+p)/2)){for(let m=L;m<=h;m++){let _=m,g=s[m];for(let v=m+1;v<p;v++)u(g,s[v])||(_=v,g=s[v],ke(s,m,_))}})(t,(s,u)=>s.center[c]<u.center[c],e,a,d);else{if(f.max[c]===f.min[c])return Ze(t.slice(e,a),n);{const u=[];for(let m=0;m<12;m++)u.push({bounds:new ie,count:0});for(let m=e;m<a;m++){let _=Math.floor(12*Ke(f,c,t[m].center));_===u.length&&(_=u.length-1),u[_].count++,u[_].bounds.union(t[m].bounds)}const L=[];for(let m=0;m<u.length-1;m++){const _=new ie,g=new ie;let v=0,A=0;for(let M=0;M<=m;M++)_.union(u[M].bounds),v+=u[M].count;for(let M=m+1;M<u.length;M++)g.union(u[M].bounds),A+=u[M].count;L.push(.1+(v*Pe(_)+A*Pe(g))/Pe(n))}let p=L[0],h=0;for(let m=1;m<L.length;m++)L[m]<p&&(p=L[m],h=m);d=function(m,_,g=0,v=m.length){for(;g!==v;){for(;_(m[g]);)if(++g===v)return g;do if(g===--v)return g;while(!_(m[v]));ke(m,g,v),g++}return g}(t,m=>{let _=Math.floor(u.length*Ke(f,c,m.center));return _===u.length&&(_=u.length-1),_<=h},e,a)}}return i=c,o=Re(t,e,d),l=Re(t,d,a),{child0:o,child1:l,bounds:new ie().union(o.bounds).union(l.bounds),splitAxis:i}}var i,o,l}function Xt(t){const e=function(a){const n=[],r=a.getIndex?a.getIndex().array:a.index.array,i=a.getAttribute?a.getAttribute("position"):a.attributes.position,o=a.getAttribute?a.getAttribute("materialMeshIndex"):a.attributes.materialMeshIndex,l=new K,f=new K,c=new K,d=new K,s=new K;for(let u=0;u<r.length;u+=3){const L=r[u],p=r[u+1],h=r[u+2],m=new ie;i.getX?(l.fromBufferAttribute(i,L),f.fromBufferAttribute(i,p),c.fromBufferAttribute(i,h)):(l.x=i.array[L*i.itemSize],l.y=i.array[L*i.itemSize+1],l.z=i.array[L*i.itemSize+2],f.x=i.array[p*i.itemSize],f.y=i.array[p*i.itemSize+1],f.z=i.array[p*i.itemSize+2],c.x=i.array[h*i.itemSize],c.y=i.array[h*i.itemSize+1],c.z=i.array[h*i.itemSize+2]),m.expandByPoint(l),m.expandByPoint(f),m.expandByPoint(c),d.subVectors(c,l),s.subVectors(f,l);const _=new K().crossVectors(s,d).normalize(),g={bounds:m,center:m.getCenter(new K),indices:[L,p,h],faceNormal:_,materialIndex:o.getX?o.getX(L):o.array[L*o.itemSize]};n.push(g)}return n}(t);return Re(e,0,e.length)}function zt(t){let e;if(e={width:t.data.image.width,height:t.data.image.height,data:t.data.image.data,dataFormat:"float"},t.data.type===Lt?e.data?e.data=function(a,n=1){const r=a.length/4,i=new Float32Array(3*r),o=[];for(let l=0;l<255;l++)o[l]=n*Math.pow(2,l-128)/255;for(let l=0;l<r;l++){const f=a[4*l],c=a[4*l+1],d=a[4*l+2],s=o[a[4*l+3]];i[3*l]=f*s,i[3*l+1]=c*s,i[3*l+2]=d*s}return i}(e.data,t.intensity):(e.data=function(a){const n=document.createElement("canvas"),r=n.getContext("2d");return n.width=a.width,n.height=a.height,r.drawImage(a,0,0),r.getImageData(0,0,n.width,n.height).data}(t.data.image),e.dataFormat="byte"):t.data.type==ht?console.error("Please use 'new RGBELoader().setDataType(THREE.FloatType)' to load hdr env map. Half-Float type will loss of precision and have an impression of the effect."):t.data.type!==we&&console.error(`No support environmentLight's data type: ${t.data.type.toString()}`),t.data.type===we&&t.data.format===vt){const a=t.data.image.data,n=a.length/4,r=new Float32Array(3*n);for(let i=0;i<n;i++)r[3*i+0]=a[4*i+0],r[3*i+1]=a[4*i+1],r[3*i+2]=a[4*i+2];e.data=r}return e}function Bt(t){const e=t.data,a={width:t.width+2,height:t.height+1},n=function(i,o,l){const f=new Float32Array(l*i*o);return{set(c,d,s,u){f[l*(d*i+c)+s]=u},get:(c,d,s)=>f[l*(d*i+c)+s],width:i,height:o,channels:l,array:f}}(a.width,a.height,2);for(let i=0;i<t.height;i++){const o=Math.sin(Math.PI*(i+.5)/t.height);for(let f=0;f<t.width;f++){const c=3*(i*t.width+f);let d=.2126*e[c]+.7152*e[c+1]+.0722*e[c+2];d*=o,n.set(f+2,i,0,n.get(f+1,i,0)+d/t.width),n.set(f+1,i,1,d)}const l=n.get(a.width-1,i,0);for(let f=1;f<n.width;f++)n.set(f,i,0,n.get(f,i,0)/l),n.set(f,i,1,n.get(f,i,1)/l);n.set(0,i+1,0,n.get(0,i,0)+l/t.height),n.set(0,i,1,l)}const r=n.get(0,n.height-1,0);for(let i=0;i<n.height;i++)n.set(0,i,0,n.get(0,i,0)/r),n.set(0,i,1,n.get(0,i,1)/r);return a.data=n.array,a}var Vt={source:t=>`
...
#endif
out_position=vec4(vPosition,float(meshIndex)+EPS);out_normal=vec4(normal,LGL_BH);out_color=vec4(color,0.);}`};function ge(t,e,a){if(e===void 0)return;const{itemSize:n,array:r}=a;if(t.enableVertexAttribArray(e),t.bindBuffer(t.ARRAY_BUFFER,t.createBuffer()),t.bufferData(t.ARRAY_BUFFER,r,t.STATIC_DRAW),r instanceof Float32Array)t.vertexAttribPointer(e,n,t.FLOAT,!1,0,0);else{if(!(r instanceof Int32Array))throw"Unsupported buffer type";t.vertexAttribIPointer(e,n,t.INT,0,0)}}function kt(t,{materialBuffer:e,mergedMesh:a}){const n=oe(t,{defines:e.defines,vertex:Ht,fragment:Ot});n.setTexture("diffuseMap",e.textures.diffuseMap),n.setTexture("normalMap",e.textures.normalMap);const r=a.geometry,i=r.getIndex().count,o=t.createVertexArray();t.bindVertexArray(o),function(s,u,L){ge(s,u.attribLocs.aPosition,L.getAttribute("position")),ge(s,u.attribLocs.aNormal,L.getAttribute("normal")),ge(s,u.attribLocs.aUv,L.getAttribute("uv")),ge(s,u.attribLocs.aMaterialMeshIndex,L.getAttribute("materialMeshIndex")),s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,s.createBuffer()),s.bufferData(s.ELEMENT_ARRAY_BUFFER,L.getIndex().array,s.STATIC_DRAW)}(t,n,r),t.bindVertexArray(null);let l,f=0,c=0,d=new et;return{draw:function(){d.copy(l.projectionMatrix),d.elements[8]+=2*f,d.elements[9]+=2*c,d.multiply(l.matrixWorldInverse),n.setUniform("projView",d.elements),t.bindVertexArray(o),n.useProgram(),t.enable(t.DEPTH_TEST),t.drawElements(t.TRIANGLES,i,t.UNSIGNED_INT,0),t.disable(t.DEPTH_TEST)},outputLocs:n.outputLocs,setCamera:function(s){l=s},setJitter:function(s,u){f=s,c=u},dispose:function(){n.dispose()}}}var Zt={source:`vec4 LGL_An(sampler2D map,vec2 uv){
#ifdef OES_texture_float_linear
return texture(map,uv);
#else
vec2 size=vec2(textureSize(map,0));vec2 texelSize=1.0/size;uv=uv*size-0.5;vec2 f=fract(uv);uv=floor(uv)+0.5;vec4 s1=texture(map,(uv+vec2(0,0))*texelSize);vec4 s2=texture(map,(uv+vec2(1,0))*texelSize);vec4 s3=texture(map,(uv+vec2(0,1))*texelSize);vec4 s4=texture(map,(uv+vec2(1,1))*texelSize);return mix(mix(s1,s2,f.x),mix(s3,s4,f.x),f.y);
#endif
}layout(location=0)out vec4 out_color;in vec2 vCoord;uniform sampler2D lightTex;uniform vec2 lightScale;uniform int toneMappingFun;vec3 linear(vec3 color){return color;}vec3 LGL_Av(vec3 color){return clamp(color/(vec3(1.0)+color),vec3(0.0),vec3(1.0));}vec3 LGL_Aw(vec3 color){color=max(vec3(0.0),color-0.004);return pow((color*(6.2*color+0.5))/(color*(6.2*color+1.7)+0.06),vec3(2.2));}vec3 LGL_Ax(vec3 color){return clamp((color*(2.51*color+0.03))/(color*(2.43*color+0.59)+0.14),vec3(0.0),vec3(1.0));}void main(){vec4 upscaledLight=texture(lightTex,lightScale*vCoord);vec3 light=upscaledLight.rgb/upscaledLight.a;if(toneMappingFun==0){light=linear(light);}if(toneMappingFun==1){light=LGL_Ax(light);}if(toneMappingFun==2){light=LGL_Av(light);}if(toneMappingFun==3){light=LGL_Aw(light);}light=pow(light,vec3(1.0/2.2));if(upscaledLight.a==0.){out_color=vec4(light,0.0);}else{out_color=vec4(light,1.0);}}`};const je={[$e]:0,[ct]:1,[ut]:2,[pt]:3};function Kt(t,e){const{fullscreenQuad:a,toneMapping:n}=e;let r;const i={gl:t,vertex:a.vertexShader,fragment:Zt},o=oe(t,i);o.setUniform("toneMappingFun",je[n]);const l=new fe(1,1);return{draw:function(f,c){let{light:d,lightScale:s}=f;if(s=s||l,o.setTexture("lightTex",d),o.setUniform("lightScale",s.x,s.y),c)return r.bind(),t.clear(t.COLOR_BUFFER_BIT),t.viewport(0,0,t.drawingBufferWidth,t.drawingBufferHeight),o.useProgram(),a.draw(),r.unbind(),r;o.useProgram(),a.draw()},setToneMapping:function(f){o.setUniform("toneMappingFun",je[f])},setSize:function(f,c){r=Le(t,{color:{0:D(t,{width:f,height:c,storage:"byte",magFilter:t.LINEAR,minFilter:t.LINEAR})}})},dispose:function(){o.dispose()}}}var qt={source:`layout(location=0)out vec4 out_color;uniform sampler2D inputBuffer;uniform vec2 resolution;in vec2 vCoord;
#define FXAA_PC 1
